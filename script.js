...
let abouttab = '<div class="modal-header mx-auto d-block text-center"><h3 class="about">About Developer</h3></div><div class="modal-body mx-auto d-block text-center" style="display: inline;"><div class="me">ME</div><div class="img"></div><div class="me"><span>MYself</span> <span id="and" class="me">and</span> <span class="me">I</span></div></div><div class="modal-footer mx-auto d-block text-center"> <h6 style="color: rgb(129, 10, 10); font-family: cursive;"> A software developer <br> @ <br> AlFulaani meda360 software</h6></div>    '
